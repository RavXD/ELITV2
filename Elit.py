...
╚══════╝╚══════╝╚═╝   ╚═╝   ╚══════╝      ╚═══╝  ╚══════╝
                                                         """ +k+"""
 Eliters"""+p+""" {"""+h+"""ELT"""+p+"""}"""+a+""" \/ {"""+k+"""Author"""+a+""": """+h+"""Rav Pratama XD."""+a+"""} """
 	print h+" >>>"+p+" IP: "+k+ip
...
def login():
  ...
  try:
	...
	print h+" ["+p+"4"+h+"]"+p+" Ikuti Instagram"+h+" RavPratama990"
				...
				if user_agent_ == cokiez: 
					...
					if "|" in user_agentzz_:
						...
						if ":" in str(lim_dev) or "-" in str(lim_dev):
							...
							print p+" [>] Ini No WA Admin:"+p+" 083818101132"
							try:
